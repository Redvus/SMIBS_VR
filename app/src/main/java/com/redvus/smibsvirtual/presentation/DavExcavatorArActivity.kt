...
class DavExcavatorArActivity : AppCompatActivity() {
    companion object {
        private const val TAG = "DaVExcavatorArActivity"
    }

    lateinit var arCoreSessionHelper: ARCoreSessionLifecycleHelper
    lateinit var view: DaVExcavatorArView
    private lateinit var renderer: DaVExcavatorArRenderer
...
//        setSupportActionBar(binding.toolbarMain)
        ...
        renderer = DaVExcavatorArRenderer(this)
