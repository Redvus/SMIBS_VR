...
import com.redvus.smibsvirtual.data.DaVAutoArRenderer
...
import com.redvus.smibsvirtual.domain.DaVAutoArView
...
class DaVAutoArActivity : AppCompatActivity() {
    companion object {
        private const val TAG = "DaVAutoActivity"
    }

    lateinit var arCoreSessionHelper: ARCoreSessionLifecycleHelper
    lateinit var view: DaVAutoArView
    private lateinit var renderer: DaVAutoArRenderer
...
//        setSupportActionBar(binding.toolbarMain)
        ...
        renderer = DaVAutoArRenderer(this)
