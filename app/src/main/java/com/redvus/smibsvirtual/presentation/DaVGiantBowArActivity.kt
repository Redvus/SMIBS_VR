...
import com.redvus.smibsvirtual.data.DaVGiantBowArRenderer
...
import com.redvus.smibsvirtual.domain.DaVGiantBowArView
...
class DaVGiantBowArActivity: AppCompatActivity() {
    companion object {
        private const val TAG = "DaVGiantBowArActivity"
    }

    lateinit var arCoreSessionHelper: ARCoreSessionLifecycleHelper
    lateinit var view: DaVGiantBowArView
    private lateinit var renderer: DaVGiantBowArRenderer
...
//        setSupportActionBar(binding.toolbarMain)
        ...
        renderer = DaVGiantBowArRenderer(this)
