...
import com.redvus.smibsvirtual.data.DaVParashuteArRenderer
...
import com.redvus.smibsvirtual.domain.DaVParashuteArView
...
class DaVParashuteArActivity : AppCompatActivity() {
    ...
    lateinit var view: DaVParashuteArView
    private lateinit var renderer: DaVParashuteArRenderer
...
//        setSupportActionBar(binding.toolbarMain)
        ...
        renderer = DaVParashuteArRenderer(this)
        lifecycle.addObserver(renderer)

        // Set up Hello AR UI.
        view = DaVParashuteArView(this)
        lifecycle.addObserver(view)
        setContentView(view.root)
        Toast.makeText(this, getText(R.string.davParashuteTitle), Toast.LENGTH_LONG).show()
