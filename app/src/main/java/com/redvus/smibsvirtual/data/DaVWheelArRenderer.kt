...
import com.redvus.smibsvirtual.presentation.DavWheelArActivity
...
class DaVWheelArRenderer(val activity: DavWheelArActivity) :
    SampleRender.Renderer, DefaultLifecycleObserver {
    companion object {
        val TAG = "DaVWheelArRenderer"
        ...
        try {
            ...
            virtualObjectAlbedoTexture =
                Texture.createFromAsset(
                    render,
                    "models/DaV_wheel/textures/DaV_wheel_BaseColor.png",
                    Texture.WrapMode.CLAMP_TO_EDGE,
            ...
            virtualObjectAlbedoInstantPlacementTexture =
                Texture.createFromAsset(
                    render,
                    "models/DaV_wheel/textures/DaV_wheel_Displacement.png",
                    Texture.WrapMode.CLAMP_TO_EDGE,
                    Texture.ColorFormat.SRGB
                )
            ...
            val virtualObjectPbrTexture =
                Texture.createFromAsset(
                    render,
                    "models/DaV_wheel/textures/DaV_wheel_Normal.png",
                    Texture.WrapMode.CLAMP_TO_EDGE,
                    Texture.ColorFormat.LINEAR
                )
            virtualObjectMesh = Mesh.createFromAsset(render, "models/DaV_wheel/DaV_Wheel_VR.obj")
            virtualObjectShader =
                Shader.createFromAssets(
                    render,
