...
import com.redvus.smibsvirtual.presentation.DaVGiantBowArActivity
...
class DaVGiantBowArRenderer(val activity: DaVGiantBowArActivity) :
    SampleRender.Renderer, DefaultLifecycleObserver {
        companion object {
        val TAG = "DaVGiantBowArRenderer"
            ...
            try {
                ...
                virtualObjectAlbedoTexture =
                    Texture.createFromAsset(
                        render,
                        "models/DaV_giantBow/Textures/DaV_GiantBow_BaseColor.png",
                        Texture.WrapMode.CLAMP_TO_EDGE,
                ...
                virtualObjectAlbedoInstantPlacementTexture =
                    Texture.createFromAsset(
                        render,
                        "models/DaV_giantBow/Textures/DaV_GiantBow_Displacement.png",
                        Texture.WrapMode.CLAMP_TO_EDGE,
                        Texture.ColorFormat.SRGB
                    )
                ...
                val virtualObjectPbrTexture =
                    Texture.createFromAsset(
                        render,
                        "models/DaV_giantBow/Textures/DaV_GiantBow_Normal.png",
                        Texture.WrapMode.CLAMP_TO_EDGE,
                        Texture.ColorFormat.LINEAR
                    )
                virtualObjectMesh = Mesh.createFromAsset(render, "models/DaV_giantBow/DaV_giantBowVR.obj")
                virtualObjectShader =
                    Shader.createFromAssets(
                        render,
