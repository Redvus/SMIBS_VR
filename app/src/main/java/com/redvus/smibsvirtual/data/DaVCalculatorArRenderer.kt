...
class DaVCalculatorArRenderer(val activity: DaVCalculatorArActivity) :
    SampleRender.Renderer, DefaultLifecycleObserver {
        companion object {
            val TAG = "DaVCalculatorArRenderer"
        ...
        override fun onSurfaceCreated(render: SampleRender) {
            ...
            try {
                ...
                virtualObjectMesh = Mesh.createFromAsset(render, "models/DaV_calculator/DaV_calculator.obj")
                virtualObjectShader =
                    Shader.createFromAssets(
                        render,
