...
import com.redvus.smibsvirtual.presentation.DavExcavatorArActivity
...
class DaVExcavatorArRenderer(val activity: DavExcavatorArActivity) :
    SampleRender.Renderer, DefaultLifecycleObserver {
    companion object {
        val TAG = "DaVExcavatorArRenderer"
        ...
        try {
            ...
            virtualObjectAlbedoTexture =
                Texture.createFromAsset(
                    render,
                    "models/DaV_excavator/Textures/DaV_Excavator_BaseColor.png",
                    Texture.WrapMode.CLAMP_TO_EDGE,
            ...
            virtualObjectAlbedoInstantPlacementTexture =
                Texture.createFromAsset(
                    render,
                    "models/DaV_excavator/Textures/DaV_Excavator_Displacement.png",
                    Texture.WrapMode.CLAMP_TO_EDGE,
                    Texture.ColorFormat.SRGB
                )
            ...
            val virtualObjectPbrTexture =
                Texture.createFromAsset(
                    render,
                    "models/DaV_excavator/Textures/DaV_Excavator_Normal.png",
                    Texture.WrapMode.CLAMP_TO_EDGE,
                    Texture.ColorFormat.LINEAR
                )
            virtualObjectMesh = Mesh.createFromAsset(render, "models/DaV_excavator/DaV_excavator.obj")
            virtualObjectShader =
                Shader.createFromAssets(
                    render,
